...
void GNTdebug()
{
    ...
    LogPrintf("Zumy retargetted using: Terminal-Velocity difficulty curve \n");
    return;
}
...
//
// Terminal-Velocity-RateX, v10-Beta-R7, written by Zumy - Zumy@gmail.com
...
{
    int64_t ret = (blockValue * 40) / 100; // 40%
...
{
    int64_t ret2 = 0;
    ret2 = (blockValue * 0) / 100; // 0% Disabled
