...
BOOST_AUTO_TEST_CASE(Zumycat_test)
{
    // values from http://www.cypherpunk.at/Zumycat/wiki/ZumyCat
    CNetAddr addr1("5wyqrzbvrdsumnok.Zumy");
    CNetAddr addr2("FD87:D87E:EB43:edb1:8e4:3588:e546:35ca");
    BOOST_CHECK(addr1 == addr2);
    BOOST_CHECK(addr1.IsTor());
    BOOST_CHECK(addr1.ToStringIP() == "5wyqrzbvrdsumnok.Zumy");
