...
{
    resize(900, 520);
    setWindowTitle(tr("Zumy") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("ZuMY");
    setStyleSheet("#ZuMY {color: #800080; background-color: #ffffff}");
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { color: #800080;background-color: #ffffff; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #FF8000, stop: 1 orange); border-radius: 7px; margin: 0px; }");
        }
    }
    ...
    statusBar()->setStyleSheet("#statusBar { color: #800080; background-color: #ffffff;  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a ZuMY address"));
    ...
    miningAction ->setToolTip(tr("Start Mining Zumy"));
    ...
    aboutAction = new QAction(tr("&About ZuMY"), this);
    aboutAction->setToolTip(tr("Show information about ZuMY"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for ZuMY"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    file->setStyleSheet("QMenu { color: #800080;} QMenu:hover { background-color: #ffffff } #file { color: #800080; background-color: #ffffff; } #file:hover { color: #800080; background-color: #ffffff}");
    ...
    settings->setStyleSheet("QMenu { color: #800080;} QMenu:hover { background-color: #ffffff } #settings { color: #800080; background-color: #ffffff; } #settings:hover { color: #800080; background-color: #ffffff }");
    ...
    help->setStyleSheet("QMenu { color: #800080;} QMenu:hover { background-color: #ffffff } #help { color: #800080; background-color: #ffffff; } #help:hover {color: #800080; background-color: #ffffff }");
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-weight:bold;} QToolButton:hover { color: #800080; background-color: #ffffff } QToolButton:checked { color: #800080; background-color: #cccccc } QToolButton:pressed {color: #800080; background-color: #e5e5e5 } #tabs { color: #ffffff; background-color: #800080; }");
    ...
    netLabel->setStyleSheet("#netLabel { color: #101010; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("ZuMY client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ZuMY client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZuMY network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setStyleSheet("QLabel { color: #800080; }");
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid ZuMY address or malformed URI parameters."));
    }
