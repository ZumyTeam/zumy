...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZMY");
    case mBTC: return QString("mZMY");
    case uBTC: return QString::fromUtf8("μZMY");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZuMYs");
    case mBTC: return QString("Milli-ZuMYs (1 / 1,000)");
    case uBTC: return QString("Micro-ZuMYs (1 / 1,000,000)");
    default: return QString("???");
    }
}
