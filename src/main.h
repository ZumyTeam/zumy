...
bool AcceptToMemoryPool(CTxMemPool& pool, CTransaction &tx, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectzumyFee=false, bool ignoreFees=false);

bool AcceptableInputs(CTxMemPool& pool, const CTransaction &txo, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectzumyFee=false, bool isDSTX=false);
...
public:
    ...
    bool AcceptToMemoryPool(bool fLimitFree=true, bool fRejectzumyFee=true, bool ignoreFees=false);
...
public:
    ...
    uint256 GetHash() const
    {
        return Hashskein512(BEGIN(nVersion), END(nNonce));
    }
