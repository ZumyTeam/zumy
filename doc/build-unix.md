...
memory available when compiling ZuMY Core. With 512MB of memory or less
...
# Configure ZuMY Core to use our own-built instance of BDB
cd $ZuMY_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip ZuMYd" to strip the debug
